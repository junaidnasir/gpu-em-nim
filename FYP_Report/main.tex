...
{\large \bfseries \ Engr. Attique Dawood}\\[1.3cm]
...
\fancyhead[RO]{\emph{Table of Contents}\hfill\thepage}
\fancyhead[LE]{\thepage\hfill\emph{Table of Contents}}
\tableofcontents % Write out the Table of Contents

%\lhead{\emph{List of Figures}} % Set the left side page header to "List of Figures"
\fancyhead[RO]{\emph{List of Figures}\hfill\thepage}
\fancyhead[LE]{\thepage\hfill\emph{List of Figures}}
\listoffigures % Write out the List of Figures

%\lhead{\emph{List of Tables}} % Set the left side page header to "List of Tables"
\fancyhead[RO]{\emph{List of Tables}\hfill\thepage}
\fancyhead[LE]{\thepage\hfill\emph{List of Tables}}
...
\fancyhead[RO]{\emph{Abbreviations}\hfill\thepage}
\fancyhead[LE]{\thepage\hfill\emph{Abbreviations}}
...
\fancyhead[RO]{\emph{Physical Constants}\hfill\thepage}
\fancyhead[LE]{\thepage\hfill\emph{Physical Constants}}
...
\fancyhead[RO]{\emph{Symbols}\hfill\thepage}
\fancyhead[LE]{\thepage\hfill\emph{Symbols}}
...
\fancyhead[RO]{\emph{Bibliography}\hfill\thepage}
\fancyhead[LE]{\thepage\hfill\emph{Bibliography}}
