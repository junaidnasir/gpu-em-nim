; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.30319.01 
	...
	TITLE	C:\Users\Ezio\Desktop\FYP\OpenCLTemplate\OpenCLTemplateMain.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	SEGMENT
$SG85216 DB	' seconds.', 00H
	ORG $+2
$SG85217 DB	'Total time taken = ', 00H
CONST	ENDS
...
EXTRN	?GetElapsedTime@COpenCLTemplate@@QAENXZ:PROC	; COpenCLTemplate::GetElapsedTime
...
EXTRN	??0COpenCLTemplate@@QAE@IN@Z:PROC		; COpenCLTemplate::COpenCLTemplate
...
; File c:\users\ezio\desktop\fyp\opencltemplate\opencltemplatemain.cpp
CONST	SEGMENT
...
_TEXT	SEGMENT
$T89781 = -308						; size = 4
_OpenCLTemplateSim$ = -104				; size = 88
__$EHRec$ = -12						; size = 12
_argc$ = 8						; size = 4
_argv$ = 12						; size = 4
_main	PROC
...
; Line 7
	...
	call	??0COpenCLTemplate@@QAE@IN@Z		; COpenCLTemplate::COpenCLTemplate
...
; Line 13
	...
	push	OFFSET $SG85216
	lea	ecx, DWORD PTR _OpenCLTemplateSim$[ebp]
	call	?GetElapsedTime@COpenCLTemplate@@QAENXZ	; COpenCLTemplate::GetElapsedTime
	sub	esp, 8
	fstp	QWORD PTR [esp]
	push	OFFSET $SG85217
...
; Line 434
	...
	add	esp, 4
	mov	DWORD PTR __Nput_fac$85533[ebp], eax
	mov	BYTE PTR __$EHRec$[ebp+12], 0
	lea	ecx, DWORD PTR $T89811[ebp]
...
$LN7@operator:
	...
	push	edx
	lea	eax, DWORD PTR $T89815[ebp]
	push	eax
	mov	ecx, DWORD PTR __Nput_fac$85533[ebp]
...
; Line 444
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR $T89816[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+12], -1
	lea	ecx, DWORD PTR __Ok$[ebp]
	call	??1sentry@?$basic_ostream@DU?$char_traits@D@std@@@std@@QAE@XZ ; std::basic_ostream<char,std::char_traits<char> >::sentry::~sentry
	mov	eax, DWORD PTR $T89816[ebp]
; Line 445
	push	edx
	mov	ecx, ebp
	push	eax
...
; Line 123
	...
	mov	DWORD PTR $T89839[ebp], ecx
	lea	ecx, DWORD PTR __Lock$76710[ebp]
	call	??1_Lockit@std@@QAE@XZ			; std::_Lockit::~_Lockit
	mov	eax, DWORD PTR $T89839[ebp]
; Line 125
	push	edx
	mov	ecx, ebp
	push	eax
...
; Line 452
	...
	mov	edx, DWORD PTR $T89847[ebp]
	or	edx, 1
	mov	DWORD PTR $T89847[ebp], edx
...
; Line 535
	...
	mov	DWORD PTR $T89859[ebp], ecx
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR tv153[ebp], eax
	mov	edx, DWORD PTR tv153[ebp]
	mov	DWORD PTR $T89860[ebp], edx
	lea	eax, DWORD PTR $T89859[ebp]
	push	eax
	lea	ecx, DWORD PTR $T89860[ebp]
	push	ecx
...
; Line 319
	push	1
	lea	eax, DWORD PTR $T89903[ebp]
	push	eax
	call	?make_error_code@std@@YA?AVerror_code@1@W4io_errc@31@@Z ; std::make_error_code
	add	esp, 8
	push	eax
	push	OFFSET ??_C@_0BG@FMKFHCIL@ios_base?3?3failbit?5set?$AA@
	lea	ecx, DWORD PTR $T89902[ebp]
	call	??0failure@ios_base@std@@QAE@PBDABVerror_code@2@@Z ; std::ios_base::failure::failure
	push	OFFSET __TI4?AVfailure@ios_base@std@@
	lea	ecx, DWORD PTR $T89902[ebp]
	push	ecx
...
; Line 321
	push	1
	lea	eax, DWORD PTR $T89905[ebp]
	push	eax
	call	?make_error_code@std@@YA?AVerror_code@1@W4io_errc@31@@Z ; std::make_error_code
	add	esp, 8
	push	eax
	push	OFFSET ??_C@_0BF@OOHOMBOF@ios_base?3?3eofbit?5set?$AA@
	lea	ecx, DWORD PTR $T89904[ebp]
	call	??0failure@ios_base@std@@QAE@PBDABVerror_code@2@@Z ; std::ios_base::failure::failure
	push	OFFSET __TI4?AVfailure@ios_base@std@@
	lea	ecx, DWORD PTR $T89904[ebp]
	push	ecx
...
$LN5@sputc:
	...
	mov	DWORD PTR $T89957[ebp], eax
	mov	eax, DWORD PTR $T89957[ebp]
	mov	cl, BYTE PTR __Ch$[ebp]
	mov	BYTE PTR [eax], cl
	mov	edx, DWORD PTR $T89957[ebp]
	push	edx
...
; Line 784
	...
	mov	DWORD PTR $T90026[ebp], ecx
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR tv285[ebp], eax
	mov	edx, DWORD PTR tv285[ebp]
	mov	DWORD PTR $T90027[ebp], edx
	lea	eax, DWORD PTR $T90026[ebp]
	push	eax
	lea	ecx, DWORD PTR $T90027[ebp]
	push	ecx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
...
; Line 797
	...
	mov	DWORD PTR $T90028[ebp], ecx
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR tv292[ebp], eax
	mov	edx, DWORD PTR tv292[ebp]
	mov	DWORD PTR $T90029[ebp], edx
	lea	eax, DWORD PTR $T90028[ebp]
	push	eax
	lea	ecx, DWORD PTR $T90029[ebp]
	push	ecx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
...
; Line 807
	mov	eax, DWORD PTR __Ostr$[ebp]
	mov	DWORD PTR $T90030[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+12], -1
	lea	ecx, DWORD PTR __Ok$[ebp]
	call	??1sentry@?$basic_ostream@DU?$char_traits@D@std@@@std@@QAE@XZ ; std::basic_ostream<char,std::char_traits<char> >::sentry::~sentry
	mov	eax, DWORD PTR $T90030[ebp]
; Line 808
	push	edx
	mov	ecx, ebp
	push	eax
...
$T90063 = -292						; size = 12
$T90064 = -272						; size = 4
__Pfmod$87956 = -68					; size = 4
__Pf$87945 = -56					; size = 4
__Id$87944 = -44					; size = 4
__Psave$87932 = -32					; size = 4
__Lock$87931 = -20					; size = 4
__$EHRec$ = -12						; size = 12
__Loc$ = 8						; size = 4
...
; Line 505
	push	0
	lea	ecx, DWORD PTR __Lock$87931[ebp]
	call	??0_Lockit@std@@QAE@H@Z			; std::_Lockit::_Lockit
	mov	DWORD PTR __$EHRec$[ebp+8], 0
; Line 507
	...
	mov	DWORD PTR __Psave$87932[ebp], eax
; Line 509
	...
	mov	DWORD PTR __Id$87944[ebp], eax
; Line 510
	mov	eax, DWORD PTR __Id$87944[ebp]
	push	eax
	mov	ecx, DWORD PTR __Loc$[ebp]
	call	?_Getfacet@locale@std@@QBEPBVfacet@12@I@Z ; std::locale::_Getfacet
	mov	DWORD PTR __Pf$87945[ebp], eax
; Line 512
	cmp	DWORD PTR __Pf$87945[ebp], 0
	je	SHORT $LN6@use_facet
	jmp	SHORT $LN5@use_facet
$LN6@use_facet:
; Line 514
	cmp	DWORD PTR __Psave$87932[ebp], 0
	je	SHORT $LN4@use_facet
; Line 515
	mov	eax, DWORD PTR __Psave$87932[ebp]
	mov	DWORD PTR __Pf$87945[ebp], eax
	jmp	SHORT $LN5@use_facet
$LN4@use_facet:
; Line 516
	...
	push	eax
	lea	ecx, DWORD PTR __Psave$87932[ebp]
	push	ecx
...
; Line 520
	...
	lea	ecx, DWORD PTR $T90063[ebp]
	call	??0bad_cast@std@@QAE@PBD@Z		; std::bad_cast::bad_cast
	push	OFFSET __TI2?AVbad_cast@std@@
	lea	eax, DWORD PTR $T90063[ebp]
	push	eax
	call	__CxxThrowException@8
; Line 526
	jmp	SHORT $LN5@use_facet
...
; Line 531
	mov	eax, DWORD PTR __Psave$87932[ebp]
	mov	DWORD PTR __Pfmod$87956[ebp], eax
; Line 532
	mov	ecx, DWORD PTR __Pfmod$87956[ebp]
	call	?_Incref@facet@locale@std@@QAEXXZ	; std::locale::facet::_Incref
; Line 533
	mov	ecx, DWORD PTR __Pfmod$87956[ebp]
...
$LN5@use_facet:
; Line 536
	mov	eax, DWORD PTR __Pf$87945[ebp]
	mov	DWORD PTR $T90064[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Lock$87931[ebp]
	call	??1_Lockit@std@@QAE@XZ			; std::_Lockit::~_Lockit
	mov	eax, DWORD PTR $T90064[ebp]
$LN8@use_facet:
; Line 538
	push	edx
	mov	ecx, ebp
...
; Line 1054
	...
	or	edx, 1
	mov	DWORD PTR $T90102[ebp], edx
	mov	eax, DWORD PTR tv133[ebp]
	push	eax
	mov	ecx, DWORD PTR $T90096[ebp]
...
$LN5@Getcat:
	...
	mov	DWORD PTR $T90095[ebp], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], 2
	mov	edx, DWORD PTR __Ppf$[ebp]
	mov	eax, DWORD PTR $T90095[ebp]
	mov	DWORD PTR [edx], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	ecx, DWORD PTR $T90102[ebp]
	and	ecx, 1
	je	SHORT $LN1@Getcat
	and	DWORD PTR $T90102[ebp], -2		; fffffffeH
	lea	ecx, DWORD PTR $T90098[ebp]
...
; Line 78
	...
	lea	ecx, DWORD PTR $T90114[ebp]
	call	??0runtime_error@std@@QAE@PBD@Z		; std::runtime_error::runtime_error
	push	OFFSET __TI2?AVruntime_error@std@@
	lea	eax, DWORD PTR $T90114[ebp]
	push	eax
	call	__CxxThrowException@8
$LN1@Locinfo:
; Line 79
...
$T86813 = -360						; size = 32
$T86815 = -320						; size = 32
__Fillcount$86816 = -88					; size = 4
__Str$86756 = -76					; size = 32
__Punct_fac$86749 = -36					; size = 4
_this$ = -24						; size = 4
...
; Line 1149
	...
	add	esp, 4
	mov	DWORD PTR __Punct_fac$86749[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR $T90175[ebp]
	call	??1locale@std@@QAE@XZ			; std::locale::~locale
; Line 1150
	lea	ecx, DWORD PTR __Str$86756[ebp]
...
; Line 1151
	...
	je	SHORT $LN3@do_put
; Line 1152
	lea	eax, DWORD PTR $T86813[ebp]
	push	eax
	mov	ecx, DWORD PTR __Punct_fac$86749[ebp]
...
$LN9@do_put:
	...
	mov	DWORD PTR __Fillcount$86816[ebp], eax
; Line 1160
	mov	ecx, DWORD PTR __Iosbase$[ebp]
	call	?flags@ios_base@std@@QBEHXZ		; std::ios_base::flags
	and	eax, 448				; 000001c0H
	...
	je	SHORT $LN1@do_put
; Line 1162
	mov	eax, DWORD PTR __Fillcount$86816[ebp]
	push	eax
	movzx	ecx, BYTE PTR __Fill$[ebp]
	push	ecx
	mov	edx, DWORD PTR __Dest$[ebp+4]
...
; Line 1163
	mov	DWORD PTR __Fillcount$86816[ebp], 0
$LN1@do_put:
; Line 1165
	lea	ecx, DWORD PTR __Str$86756[ebp]
	call	?size@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEIXZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::size
...
; Line 1993
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+4]
	mov	DWORD PTR __Ptr$86297[ebp], ecx
; Line 1994
...
; Line 1995
	...
	push	eax
	mov	ecx, DWORD PTR __Ptr$86297[ebp]
	push	ecx
	mov	edx, DWORD PTR _this$[ebp]
	add	edx, 4
	push	edx
...
; Line 1996
	...
	add	ecx, 1
	push	ecx
	mov	edx, DWORD PTR __Ptr$86297[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 28					; 0000001cH
...
$LN18@do_put@6:
	...
	mov	BYTE PTR __Signed$86862[ebp], al
; Line 1230
	movzx	eax, BYTE PTR __Signed$86862[ebp]
	test	eax, eax
...
$LN18@do_put@7:
	...
	mov	BYTE PTR __Signed$86885[ebp], al
; Line 1271
	movzx	eax, BYTE PTR __Signed$86885[ebp]
	test	eax, eax
...
; Line 1953
	...
	mov	DWORD PTR _this$[ebp], ecx
; Line 1954
	mov	BYTE PTR $T90361[ebp], 0
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR __Newsize$[ebp]
	mov	DWORD PTR [eax+20], ecx
	lea	edx, DWORD PTR $T90361[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
...
$T90396 = -472						; size = 8
$T90397 = -456						; size = 8
__Expoffset$87093 = -248				; size = 4
__Fracoffset$87086 = -236				; size = 4
__Adjustfield$ = -224					; size = 4
__Fillcount$ = -212					; size = 4
__Off$87066 = -200					; size = 4
__Pg$87065 = -188					; size = 4
...
; Line 1380
	lea	ecx, DWORD PTR __Grouping$[ebp]
	call	?c_str@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEPBDXZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::c_str
	mov	DWORD PTR __Pg$87065[ebp], eax
; Line 1381
	...
	call	_strcspn
	add	esp, 8
	mov	DWORD PTR __Off$87066[ebp], eax
$LN9@Fput:
; Line 1383
	mov	eax, DWORD PTR __Pg$87065[ebp]
	movsx	ecx, BYTE PTR [eax]
	...
	mov	eax, DWORD PTR __Pg$87065[ebp]
	movsx	ecx, BYTE PTR [eax]
	mov	edx, DWORD PTR __Off$87066[ebp]
...
; Line 1385
	...
	mov	edx, DWORD PTR __Off$87066[ebp]
	sub	edx, ecx
	mov	DWORD PTR __Off$87066[ebp], edx
	push	0
	push	1
	mov	eax, DWORD PTR __Off$87066[ebp]
	push	eax
	lea	ecx, DWORD PTR __Groupstring$[ebp]
	call	?insert@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAAV12@IID@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::insert
; Line 1386
...
; Line 1422
	...
	add	eax, 1
	mov	DWORD PTR __Fracoffset$87086[ebp], eax
; Line 1423
	movzx	eax, BYTE PTR __Kseparator$[ebp]
	push	eax
	mov	ecx, DWORD PTR __Fracoffset$87086[ebp]
	sub	ecx, 1
	push	ecx
	mov	edx, DWORD PTR __Buf$[ebp]
	push	edx
...
; Line 1427
	mov	eax, DWORD PTR __Buf$[ebp]
	add	eax, DWORD PTR __Fracoffset$87086[ebp]
	mov	DWORD PTR __Buf$[ebp], eax
	mov	ecx, DWORD PTR __Count$[ebp]
	sub	ecx, DWORD PTR __Fracoffset$87086[ebp]
	mov	DWORD PTR __Count$[ebp], ecx
$LN2@Fput:
; Line 1431
	mov	eax, DWORD PTR __Count$[ebp]
...
; Line 1434
	...
	sub	eax, DWORD PTR __Buf$[ebp]
	add	eax, 1
	mov	DWORD PTR __Expoffset$87093[ebp], eax
; Line 1435
	movzx	eax, BYTE PTR __Kseparator$[ebp]
	push	eax
	mov	ecx, DWORD PTR __Expoffset$87093[ebp]
	sub	ecx, 1
	push	ecx
	mov	edx, DWORD PTR __Buf$[ebp]
	push	edx
...
; Line 1439
	mov	eax, DWORD PTR __Buf$[ebp]
	add	eax, DWORD PTR __Expoffset$87093[ebp]
	mov	DWORD PTR __Buf$[ebp], eax
	mov	ecx, DWORD PTR __Count$[ebp]
	sub	ecx, DWORD PTR __Expoffset$87093[ebp]
	mov	DWORD PTR __Count$[ebp], ecx
$LN1@Fput:
; Line 1443
	movzx	eax, BYTE PTR __Kseparator$[ebp]
...
__Off$87121 = -100					; size = 4
__Pg$87120 = -88					; size = 4
__Prefix$ = -76						; size = 4
__Grouping$ = -64					; size = 32
__Punct_fac$ = -24					; size = 4
__$ArrayPad$ = -16					; size = 4
...
; Line 1489
	lea	ecx, DWORD PTR __Grouping$[ebp]
	call	?c_str@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEPBDXZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::c_str
	mov	DWORD PTR __Pg$87120[ebp], eax
; Line 1490
	mov	eax, DWORD PTR __Count$[ebp]
	mov	DWORD PTR __Off$87121[ebp], eax
$LN9@Iput:
; Line 1492
	mov	eax, DWORD PTR __Pg$87120[ebp]
	movsx	ecx, BYTE PTR [eax]
	cmp	ecx, 127				; 0000007fH
	je	$LN10@Iput
	mov	eax, DWORD PTR __Pg$87120[ebp]
	...
	mov	eax, DWORD PTR __Pg$87120[ebp]
	movsx	ecx, BYTE PTR [eax]
	mov	edx, DWORD PTR __Off$87121[ebp]
	sub	edx, DWORD PTR __Prefix$[ebp]
	cmp	ecx, edx
	jae	SHORT $LN10@Iput
; Line 1494
	...
	mov	edx, DWORD PTR __Off$87121[ebp]
	sub	edx, ecx
	mov	DWORD PTR __Off$87121[ebp], edx
$LN6@Iput:
; Line 1496
	xor	eax, eax
	jne	SHORT $LN6@Iput
; Line 1497
	mov	eax, DWORD PTR __Count$[ebp]
	add	eax, 1
	sub	eax, DWORD PTR __Off$87121[ebp]
	push	eax
	mov	ecx, DWORD PTR __Buf$[ebp]
	add	ecx, DWORD PTR __Off$87121[ebp]
	push	ecx
	mov	edx, DWORD PTR __Count$[ebp]
	add	edx, 1
	sub	edx, DWORD PTR __Off$87121[ebp]
	push	edx
	mov	eax, DWORD PTR __Off$87121[ebp]
	mov	ecx, DWORD PTR __Buf$[ebp]
...
; Line 1500
	mov	eax, DWORD PTR __Buf$[ebp]
	add	eax, DWORD PTR __Off$87121[ebp]
	mov	BYTE PTR [eax], 0
	mov	ecx, DWORD PTR __Count$[ebp]
	add	ecx, 1
	mov	DWORD PTR __Count$[ebp], ecx
...
; Line 84
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	ecx, DWORD PTR $T90461[ebp]
	or	ecx, 1
	mov	DWORD PTR $T90461[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
; Line 85
	pop	edi
	pop	esi
...
; Line 89
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	ecx, DWORD PTR $T90466[ebp]
	or	ecx, 1
	mov	DWORD PTR $T90466[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
; Line 90
	pop	edi
	pop	esi
...
$T90496 = -244						; size = 8
$T90497 = -228						; size = 8
__Groupsize$87301 = -20					; size = 4
__Pend$87299 = -8					; size = 4
_this$ = 8						; size = 4
___$ReturnUdt$ = 12					; size = 4
__Dest$ = 16						; size = 8
__Ptr$ = 24						; size = 4
...
; Line 1553
	...
	call	_memchr
	add	esp, 12					; 0000000cH
	mov	DWORD PTR __Pend$87299[ebp], eax
; Line 1554
	cmp	DWORD PTR __Pend$87299[ebp], 0
	je	SHORT $LN8@Putgrouped
	mov	eax, DWORD PTR __Pend$87299[ebp]
...
$LN9@Putgrouped:
	...
	mov	DWORD PTR __Groupsize$87301[ebp], edx
; Line 1556
	mov	eax, DWORD PTR __Groupsize$87301[ebp]
	push	eax
	mov	ecx, DWORD PTR __Ptr$[ebp]
	push	ecx
	mov	edx, DWORD PTR __Dest$[ebp+4]
...
; Line 1557
	mov	eax, DWORD PTR __Ptr$[ebp]
	add	eax, DWORD PTR __Groupsize$87301[ebp]
	mov	DWORD PTR __Ptr$[ebp], eax
	mov	ecx, DWORD PTR __Count$[ebp]
	sub	ecx, DWORD PTR __Groupsize$87301[ebp]
	mov	DWORD PTR __Count$[ebp], ecx
; Line 1558
...
; Line 625
	...
	call	?sputc@?$basic_streambuf@DU?$char_traits@D@std@@@std@@QAEHD@Z ; std::basic_streambuf<char,std::char_traits<char> >::sputc
	mov	DWORD PTR $T90500[ebp], eax
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T90501[ebp], eax
	lea	edx, DWORD PTR $T90500[ebp]
	push	edx
	lea	eax, DWORD PTR $T90501[ebp]
	push	eax
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
	movzx	ecx, al
...
; Line 79
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	ecx, DWORD PTR $T90513[ebp]
	or	ecx, 1
	mov	DWORD PTR $T90513[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
; Line 80
	pop	edi
	pop	esi
...
; Line 1118
	...
	mov	ecx, DWORD PTR [eax+20]
	sub	ecx, DWORD PTR __Count$[ebp]
	mov	DWORD PTR __Newsize$87351[ebp], ecx
; Line 1119
	mov	eax, DWORD PTR __Newsize$87351[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Eos@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Eos
$LN1@erase:
...
$T90563 = -292						; size = 12
$T90564 = -272						; size = 4
__Pfmod$88029 = -68					; size = 4
__Pf$88018 = -56					; size = 4
__Id$88017 = -44					; size = 4
__Psave$88005 = -32					; size = 4
__Lock$88004 = -20					; size = 4
__$EHRec$ = -12						; size = 12
__Loc$ = 8						; size = 4
...
; Line 505
	push	0
	lea	ecx, DWORD PTR __Lock$88004[ebp]
	call	??0_Lockit@std@@QAE@H@Z			; std::_Lockit::_Lockit
	mov	DWORD PTR __$EHRec$[ebp+8], 0
; Line 507
	mov	eax, DWORD PTR ?_Psave@?$_Facetptr@V?$numpunct@D@std@@@std@@2PBVfacet@locale@2@B ; std::_Facetptr<std::numpunct<char> >::_Psave
	mov	DWORD PTR __Psave$88005[ebp], eax
; Line 509
	mov	ecx, OFFSET ?id@?$numpunct@D@std@@2V0locale@2@A ; std::numpunct<char>::id
	call	??Bid@locale@std@@QAEIXZ		; std::locale::id::operator unsigned int
	mov	DWORD PTR __Id$88017[ebp], eax
; Line 510
	mov	eax, DWORD PTR __Id$88017[ebp]
	push	eax
	mov	ecx, DWORD PTR __Loc$[ebp]
	call	?_Getfacet@locale@std@@QBEPBVfacet@12@I@Z ; std::locale::_Getfacet
	mov	DWORD PTR __Pf$88018[ebp], eax
; Line 512
	cmp	DWORD PTR __Pf$88018[ebp], 0
	je	SHORT $LN6@use_facet@2
	jmp	SHORT $LN5@use_facet@2
$LN6@use_facet@2:
; Line 514
	cmp	DWORD PTR __Psave$88005[ebp], 0
	je	SHORT $LN4@use_facet@2
; Line 515
	mov	eax, DWORD PTR __Psave$88005[ebp]
	mov	DWORD PTR __Pf$88018[ebp], eax
	jmp	SHORT $LN5@use_facet@2
$LN4@use_facet@2:
; Line 516
	mov	eax, DWORD PTR __Loc$[ebp]
	push	eax
	lea	ecx, DWORD PTR __Psave$88005[ebp]
	push	ecx
...
; Line 520
	push	OFFSET ??_C@_08EPJLHIJG@bad?5cast?$AA@
	lea	ecx, DWORD PTR $T90563[ebp]
	call	??0bad_cast@std@@QAE@PBD@Z		; std::bad_cast::bad_cast
	push	OFFSET __TI2?AVbad_cast@std@@
	lea	eax, DWORD PTR $T90563[ebp]
	push	eax
	call	__CxxThrowException@8
; Line 526
	jmp	SHORT $LN5@use_facet@2
...
; Line 531
	mov	eax, DWORD PTR __Psave$88005[ebp]
	mov	DWORD PTR __Pfmod$88029[ebp], eax
; Line 532
	mov	ecx, DWORD PTR __Pfmod$88029[ebp]
	call	?_Incref@facet@locale@std@@QAEXXZ	; std::locale::facet::_Incref
; Line 533
	mov	ecx, DWORD PTR __Pfmod$88029[ebp]
	call	?_Register@facet@locale@std@@QAEXXZ	; std::locale::facet::_Register
$LN5@use_facet@2:
; Line 536
	mov	eax, DWORD PTR __Pf$88018[ebp]
	mov	DWORD PTR $T90564[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Lock$88004[ebp]
	call	??1_Lockit@std@@QAE@XZ			; std::_Lockit::~_Lockit
	mov	eax, DWORD PTR $T90564[ebp]
$LN8@use_facet@2:
; Line 538
	push	edx
	mov	ecx, ebp
...
; Line 37
	push	0
	lea	ecx, DWORD PTR $T90581[ebp]
	call	??0bad_alloc@std@@QAE@PBD@Z		; std::bad_alloc::bad_alloc
	push	OFFSET __TI2?AVbad_alloc@std@@
	lea	eax, DWORD PTR $T90581[ebp]
	push	eax
	call	__CxxThrowException@8
$LN3@Allocate:
; Line 39
...
; Line 37
	push	0
	lea	ecx, DWORD PTR $T90590[ebp]
	call	??0bad_alloc@std@@QAE@PBD@Z		; std::bad_alloc::bad_alloc
	push	OFFSET __TI2?AVbad_alloc@std@@
	lea	eax, DWORD PTR $T90590[ebp]
	push	eax
	call	__CxxThrowException@8
$LN3@Allocate@2:
; Line 39
...
; Line 202
	...
	add	esp, 8
	mov	DWORD PTR $T90597[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T90597[ebp], 0
	...
	mov	edx, DWORD PTR [eax]
	mov	eax, DWORD PTR [eax+4]
	mov	ecx, DWORD PTR $T90597[ebp]
	mov	DWORD PTR [ecx], edx
	mov	DWORD PTR [ecx+4], eax
	mov	edx, DWORD PTR $T90597[ebp]
...
; Line 114
	call	?_DebugHeapTag_func@std@@YAABU_DebugHeapTag_t@1@XZ ; std::_DebugHeapTag_func
	mov	DWORD PTR $T90617[ebp], eax
	push	113					; 00000071H
	push	OFFSET ??_C@_0EH@FHANIOCG@c?3?2program?5files?5?$CIx86?$CJ?2microsoft@
	mov	eax, DWORD PTR $T90617[ebp]
	push	eax
	push	24					; 00000018H
	call	??2facet@locale@std@@SAPAXIABU_DebugHeapTag_t@2@PADH@Z ; std::locale::facet::operator new
	add	esp, 16					; 00000010H
	mov	DWORD PTR $T90616[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T90616[ebp], 0
	...
	call	?c_str@locale@std@@QBEPBDXZ		; std::locale::c_str
	push	eax
	lea	ecx, DWORD PTR $T90618[ebp]
	call	??0_Locinfo@std@@QAE@PBD@Z		; std::_Locinfo::_Locinfo
	mov	DWORD PTR tv139[ebp], eax
	mov	ecx, DWORD PTR tv139[ebp]
	mov	DWORD PTR tv134[ebp], ecx
	mov	BYTE PTR __$EHRec$[ebp+8], 1
	mov	edx, DWORD PTR $T90622[ebp]
	or	edx, 1
	mov	DWORD PTR $T90622[ebp], edx
	mov	eax, DWORD PTR tv134[ebp]
	push	eax
	mov	ecx, DWORD PTR $T90616[ebp]
...
$LN5@Getcat@2:
	...
	mov	DWORD PTR $T90615[ebp], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], 2
	mov	edx, DWORD PTR __Ppf$[ebp]
	mov	eax, DWORD PTR $T90615[ebp]
	mov	DWORD PTR [edx], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	ecx, DWORD PTR $T90622[ebp]
	and	ecx, 1
	je	SHORT $LN1@Getcat@2
	and	DWORD PTR $T90622[ebp], -2		; fffffffeH
	lea	ecx, DWORD PTR $T90618[ebp]
	call	??1_Locinfo@std@@QAE@XZ			; std::_Locinfo::~_Locinfo
$LN1@Getcat@2:
; Line 115
...
; Line 174
	...
	mov	edx, DWORD PTR $T90648[ebp]
	or	edx, 1
	mov	DWORD PTR $T90648[ebp], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
; Line 175
	pop	edi
	pop	esi
...
; Line 179
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBD@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	edx, DWORD PTR $T90667[ebp]
	or	edx, 1
	mov	DWORD PTR $T90667[ebp], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
; Line 180
	pop	edi
	pop	esi
...
; Line 184
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBD@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	edx, DWORD PTR $T90672[ebp]
	or	edx, 1
	mov	DWORD PTR $T90672[ebp], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
; Line 185
	pop	edi
	pop	esi
...
; Line 123
	call	__Getcvt
	mov	DWORD PTR $T90694[ebp], eax
	mov	DWORD PTR $T90694[ebp+4], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
	mov	ecx, DWORD PTR $T90694[ebp]
	mov	DWORD PTR [eax], ecx
	mov	edx, DWORD PTR $T90694[ebp+4]
	mov	DWORD PTR [eax+4], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
; Line 124
	pop	edi
...
; Line 660
	...
	add	esp, 16					; 00000010H
	mov	DWORD PTR $T90733[ebp], eax
	mov	ecx, DWORD PTR $T90733[ebp]
	mov	DWORD PTR __Ptrdest$[ebp], ecx
; Line 664
	mov	eax, DWORD PTR __Ptrdest$[ebp]
	mov	DWORD PTR __Ptrnext$88286[ebp], eax
	jmp	SHORT $LN3@Maklocstr
$LN2@Maklocstr:
	mov	eax, DWORD PTR __Count$[ebp]
	sub	eax, 1
	mov	DWORD PTR __Count$[ebp], eax
	mov	ecx, DWORD PTR __Ptrnext$88286[ebp]
	add	ecx, 1
	mov	DWORD PTR __Ptrnext$88286[ebp], ecx
	mov	edx, DWORD PTR __Ptr$[ebp]
	add	edx, 1
	mov	DWORD PTR __Ptr$[ebp], edx
$LN3@Maklocstr:
...
; Line 665
	mov	eax, DWORD PTR __Ptrnext$88286[ebp]
	mov	ecx, DWORD PTR __Ptr$[ebp]
	mov	dl, BYTE PTR [ecx]
	mov	BYTE PTR [eax], dl
